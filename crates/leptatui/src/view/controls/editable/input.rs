//! Controlled single-line input view.
...
use super::{
    insert::{flush_expired_insert_key, handle_input_key, has_active_insert_key_pending},
...
pub struct InputView {
    /// Shared editable storage configured for input behavior.
...
impl fmt::Debug for InputView {
    fn fmt(&self, formatter: &mut fmt::Formatter<'_>) -> fmt::Result {
        formatter
            .debug_struct("InputView")
...
impl_editable_view_api!(InputView);
